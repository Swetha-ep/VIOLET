"""
Django settings for violett project.
...
SECRET_KEY = 'django-insecure-eojcs!z5q@+u5$3jsjt3tpchb(x1ng!xta63j8+d*b99d=pxin'
...
WSGI_APPLICATION = 'violett.wsgi.application'
